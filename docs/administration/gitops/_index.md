---
title: "Installing KAI Scheduler with ArgoCD (GitOps)"
linkTitle: "GitOps (ArgoCD)"
weight: 40
description: "KAI Scheduler can be installed and managed by GitOps tools such as ArgoCD using the same Helm chart, with two values changed:"
---
