---
title: "Migration Guide: v0.13.x → v0.14.0"
linkTitle: "v0.14.0"
weight: 30
description: "v0.14.0 adds a global.vpa block to values.yaml, enabling"
---
...
upgrade. See [Helm Rollback Not Supported](../_index.md#-helm-rollback-not-supported)
