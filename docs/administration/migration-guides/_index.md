...
|---------|--------------------------------------------|---------------------------------------|
| v0.6.0  | Namespace rename, queue-label key update   | [v0.6.0 Migration Guide](./v0.6.0/_index.md)   |
| v0.13.0 | Queue-controller flag removal, rollback limitation | [v0.13.0 Migration Guide](./v0.13.0/_index.md) |
| v0.14.0 | `prometheus` value required on upgrade, leader election auto-enable | [v0.14.0 Migration Guide](./v0.14.0/_index.md) |
