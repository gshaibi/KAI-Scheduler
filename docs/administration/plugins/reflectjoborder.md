---
title: "Reflect Job Order Plugin"
linkTitle: "Reflect Job Order Plugin"
weight: 20
description: "The reflectjoborder plugin exposes the order in which the scheduler intends to process pending PodGroups (jobs) during the next scheduling cycle."
---
